...
export class EBook extends Book {
    ...
    set fileFormat(value) {
        ...
        if (!allowedFormats.includes(value)) {
            throw new Error(`Формат файла должен быть одним из: ${allowedFormats.join(', ')}`);
        }
        this._fileFormat = value;
    }

    printInfo() {
        console.log(`Название: ${this.bookTitle}, Автор: ${this.author}, Год выхода: ${this.date}, Формат файла: ${this.fileFormat}`);
    }
